...
export const metadata: Metadata = {
  ...
  description:
    'Family-owned painting contractor serving Cincinnati and the surrounding areas since 2004. W-2 crews, free color consultation, written itemized pricing, and a 5-year workmanship warranty.',
  keywords: [
    'painters Cincinnati',
