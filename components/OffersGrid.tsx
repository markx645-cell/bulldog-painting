      ...
      <div className="container-x">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2" data-reveal-stagger>
          {offers.map((o) => (
            ...
            >
              <span className="self-start rounded-full bg-brass-200 px-3 py-1 font-display text-[11px] font-bold uppercase tracking-widest text-graphite">
                {o.tag}
              </span>
              <h3 className="mt-4 font-display text-2xl font-bold text-graphite">{o.headline}</h3>
              <p className="mt-3 flex-1 leading-relaxed text-slate">{o.body}</p>
