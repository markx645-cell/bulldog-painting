    ...
    <section className="section bg-white">
      <div className="container-x grid gap-10 lg:grid-cols-2 lg:items-center">
        <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-lift ring-1 ring-black/5">
          ...
          <div className="absolute bottom-5 left-5 rounded-xl bg-pine-900/92 px-5 py-4 text-white shadow-lift">
            <span className="block font-display text-3xl font-extrabold leading-none text-brass">
              {stats.homesPainted}
            </span>
            <span className="mt-1 block text-[11px] uppercase tracking-widest text-slate-300">
